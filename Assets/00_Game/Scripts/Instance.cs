...
public class Instance : MonoBehaviour
{
    ...
    {
        Instantiate(trap, new Vector3(Random.Range(-9f,89f), 0.45f,Random.Range(49f,-49f)), Quaternion.identity, this.transform);
        Instantiate(trap, new Vector3(Random.Range(-9f, 89f), 0.45f, Random.Range(49f, -49f)), Quaternion.identity, this.transform);
        Instantiate(trap, new Vector3(Random.Range(-9f, 89f), 0.45f, Random.Range(49f, -49f)), Quaternion.identity, this.transform);
    }
    private void SpawnGhost()
    {
        Instantiate(ghost, new Vector3(Random.Range(-9f, 89f), 1.5f, Random.Range(49f, -49f)), Quaternion.identity, this.transform);
    }
}
